...
import id.ac.polbeng.mithazalina.kabupatenkotariauapp.databinding.ItemCardKabkotaBinding
...
RecyclerView.Adapter<CardKabKotaAdapter.CardViewHolder>(){
    ...
    inner class CardViewHolder (val binding: ItemCardKabkotaBinding): RecyclerView.ViewHolder(binding.root)
