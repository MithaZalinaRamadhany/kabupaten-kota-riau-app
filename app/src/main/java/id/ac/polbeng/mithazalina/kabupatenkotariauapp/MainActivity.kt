package id.ac.polbeng.mithazalina.kabupatenkotariauapp
...
import id.ac.polbeng.mithazalina.kabupatenkotariauapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private var currentMode: Int = R.id.action_list // Menyimpan mode saat ini
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Tambahkan data ke listData
        listData.addAll(KabKotaData.listDataKabKota)

        // Jika ada savedInstanceState, pulihkan mode tampilan
        if (savedInstanceState != null) {
            currentMode = savedInstanceState.getInt("currentMode", R.id.action_list)
    ...
    private fun setMode(selectedMode: Int) {
        currentMode = selectedMode // Simpan mode yang dipilih
        when (selectedMode) {
            R.id.action_list -> {
    ...
    // Menyimpan status mode saat ini
